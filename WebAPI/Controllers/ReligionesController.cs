...
namespace WebAPI.Controllers
{
    ...
    public class ReligionesController : MiControllerBase
    {
        ...
        public ReligionesController(IMediator mediator)
        {
            _mediator = mediator;
        }
        [HttpGet]
        ...
        {
            return await _mediator.Send(new ConsultaId.ReligionesUnico { Id = id });
        }
        ...
        [HttpDelete("{id}")]
        public async Task<ActionResult<Unit>> EliminarReligiones(Guid id)
        {
